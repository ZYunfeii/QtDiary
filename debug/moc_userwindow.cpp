...
QT_MOC_LITERAL(1, 11, 16), // "ChooseBackSignal"
QT_MOC_LITERAL(2, 28, 0) // ""

    },
    "UserWindow\0ChooseBackSignal\0"
};
...
void UserWindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ChooseBackSignal(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserWindow::ChooseBackSignal)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void UserWindow::ChooseBackSignal()
{
